...
| `REQ-03` fixture 분석 결과 반환 | `AC-01`, `AC-02`, `AC-03`, `AC-05` | `TC-01`, `TC-02`, `TC-03`, `TC-06` | `api-spec.md` |
| `REQ-04` 결과 화면 검증 | `AC-05` | `TC-01`, `TC-02`, `TC-03` | `ui-spec.md` |
| `REQ-05` 운영 모드 분리 | `AC-06`, `AC-07` | `TC-07` | `architecture.md` |

## 사용 규칙

- fixture 결과 구조가 바뀌면 `api-spec.md`, `ui-spec.md`, `traceability.md`를 함께 갱신한다.
