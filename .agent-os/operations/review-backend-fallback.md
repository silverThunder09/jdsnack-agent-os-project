...
4. Codex fallback은 origin/main...HEAD diff와 명시된 acceptance/test 기준만 읽고, 파일을 수정·커밋·푸시하지 않은 채 같은 5점 루브릭으로 구조화된 결과를 반환합니다.
5. Codex 결과가 PASS이고 4점 이상이며 위험도가 Light 또는 Standard이면 runner의 GitHub CLI가 정식 review와 auto-merge를 요청합니다.
