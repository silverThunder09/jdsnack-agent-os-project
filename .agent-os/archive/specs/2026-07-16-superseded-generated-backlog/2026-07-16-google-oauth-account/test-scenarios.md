...
- 시나리오: callback provider 오류
- 기대: 성공·실패·권한·경계 조건이 명시된 계약에 맞게 처리됩니다.

## TC-04

- 시나리오: 동일 subject 재로그인
- 기대: 성공·실패·권한·경계 조건이 명시된 계약에 맞게 처리됩니다.

## TC-05

- 시나리오: 로그아웃 후 보호 API 차단
- 기대: 성공·실패·권한·경계 조건이 명시된 계약에 맞게 처리됩니다.

## TC-06

- 시나리오: secret이 응답·프론트 번들에 노출되지 않음
- 기대: 성공·실패·권한·경계 조건이 명시된 계약에 맞게 처리됩니다.
