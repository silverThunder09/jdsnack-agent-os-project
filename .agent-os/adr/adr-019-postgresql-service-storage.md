...
T2에서는 PostgreSQL과 H2에서 동작 가능한 저장 계약과 스키마를 추가하고, migration 도구 선택은 [ADR-022 Flyway schema migrations](adr-022-flyway-schema-migrations.md)를 따릅니다. 운영 DB 전환·backup/restore 절차는 별도 운영 작업으로 다룹니다.
...
- H2와 PostgreSQL은 같은 Flyway migration 집합으로 스키마 변경 이력을 관리합니다.
