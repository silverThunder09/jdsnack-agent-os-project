...
JDSnack은 개발자 이력서와 JD를 AI로 분석하는 웹 서비스입니다. 현재 활성 기획은 JD 링크 수집 안정화이며, 과거 MVP 문서는 archive에 보관합니다.
...
5. 현재 활성 기능: `.agent-os/specs/2026-05-24-jd-link-fetch-stabilization-mvp/`
