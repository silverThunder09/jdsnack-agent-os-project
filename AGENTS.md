...
JDSnack은 개발자 이력서와 JD를 AI로 분석하는 웹 서비스입니다. 현재 활성 기획은 분석 실행 전 통합 검증 게이트이며, 과거 기획 문서는 archive에 보관합니다.
...
5. 현재 활성 기능: `.agent-os/specs/2026-06-17-analysis-prevalidation-gate/`
