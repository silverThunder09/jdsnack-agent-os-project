...
JDSnack은 개발자 이력서와 JD를 AI로 분석하는 웹 서비스입니다. 현재 활성 기획은 사람인 JD 수집 안정화이며, 과거 MVP 문서는 archive에 보관합니다.
...
6. 현재 활성 기능: `.agent-os/specs/2026-05-24-saramin-jd-scraping-stabilization/`
...
- PR 제목과 본문은 한국어로 작성합니다. 단, `type(scope)`, API path, 코드 식별자, 에러 코드는 영어를 유지합니다.
