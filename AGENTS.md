...
JDSnack은 개발자 이력서와 JD를 AI로 분석하는 웹 서비스입니다. 1차 MVP는 사용자 인증 키 입력과 서버 Gemini 연동 없이 이력서 입력, 검증, 준비중 안내 흐름을 먼저 완성합니다.
...
5. 현재 활성 기능: `.agent-os/specs/2026-05-21-0943-ai-resume-diagnoser/`

## 기준 문서 위치

- 제품 방향: `.agent-os/product/`
- 기능 명세: `.agent-os/specs/`
- 전역 표준: `.agent-os/standards/`
- 운영 규칙: `.agent-os/operations/`
- 서브 에이전트 프롬프트: `.agent-os/agents/`
- 상세 API 문서: `docs/api/`
- 상세 ERD 문서: `docs/erd/`
...
- 1차 MVP에는 사용자 인증 키 입력, 서버 외부 AI 비밀값 설정, 서버 Gemini 호출을 넣지 않습니다.
